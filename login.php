...
<head>
    ...
    <title>Login Admin | Sistem Informasi Arsip Digital Capil Mamuju</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                ...
                <h4>ARSIP DIGITAL KANTOR CAPIL KAB. MAMUJU</h4>
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="periksa_login.php" method="POST" id="loginForm">
                            ...
                            <div class="form-group">
                                <input type="hidden" required="required" autocomplete="off" name="akses" id="petugas" value="petugas" class="form-control">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Informasi Pengelolaan Arsip Digital Kantor CAPIL KAB. Mamuju(SIPAD)</p>
            </div>
        </div>
    </div>
